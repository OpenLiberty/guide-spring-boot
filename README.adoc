...
:page-search-keywords: ['Spring Boot', 'springBootUtility', 'Docker', 'Open Liberty', 'Tomcat']
:common-includes: ../guides-common/
:source-highlighter: prettify
:page-seo-title: Deploying a Spring Boot Java application
:page-seo-description: A tutorial with examples on how to containerize, package, and run a Spring Boot Java application in a Docker container on an Open Liberty server.
