...
Next, run the 'liberty:run` goal that create the Liberty, install required features, and deploy the Spring Boot application to the Liberty, and then run the application.
[role='command']
```
mvn liberty:run
```
