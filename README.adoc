...
Since the  application was thinned, the `<springbootApplication />` location is set to [hotspot=location file=1]`thin-gs-spring-boot-0.1.0.jar`. The application port is also specified as [hotspot=14 file=1]`9080`.
