...
== What you'll learn
The starting point of this guide will be the finished application from Spring's https://spring.io/guides/gs/spring-boot/[Building an Application with Spring Boot^] guide. Please first go through that guide first, if you are not familiar with Spring Boot. Note that Java 8 is required to run this project.
