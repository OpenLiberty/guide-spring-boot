...
The [hotspot=include file=0]`<include />` tag of this execution is specified to `minify`, `runnable`. The `runnable` value allows the application to be generated as a `jar` file. 
