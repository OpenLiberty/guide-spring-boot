...
However, in order to run the Spring Boot application the value will be set as `spring-boot-application`. This allows maven to package and copy the `spring-boot-project` to Liberty's runtime's application directory. 
