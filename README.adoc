...
:page-majorupdateddate: 2024-12-05
...
You see more logs from Spring for restoring. Liberty’s startup is complete in less than a second. It shows a faster startup time than the original `springboot` image that you built in the previous section.
