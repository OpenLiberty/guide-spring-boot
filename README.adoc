...
== What you'll learn
You will learn how to deploy a Spring Boot application on a Liberty server in Docker without modification by using the Spring Boot utility thin command to create a thin jar and indexed library. 
