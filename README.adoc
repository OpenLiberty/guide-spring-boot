...
== What you'll learn
Spring Boot is an open source Java-based framework used to develop microservices. 
You will learn how to deploy a Spring Boot application in Open Liberty and how to run the Spring Boot application in a Docker image.
...
== Deploying the application to Docker container
...
configuration file created in the previous section, and copies the library cache [hotspot=libcache]`lib.index.cache` and 
