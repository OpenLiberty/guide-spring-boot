...
:page-description: Learn how to run a Spring Boot application with Open Liberty.
:page-tags: []
...
Learn how to run a Spring Boot application on a Liberty server.

== What you'll learn
You will learn how to build and run a Spring Boot application with a Open Liberty Docker image, how to run it locally with a  Liberty server, and how to repackage it embedded with a Liberty server.
