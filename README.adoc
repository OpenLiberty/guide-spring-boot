...
InstantOn requires a Linux system with kernel version 5.9 or greater. If your system does not meet this prerequisite, go to the <<running-the-application-on-open-liberty>> section. You can run the following command to check out the kernel version of your system:
