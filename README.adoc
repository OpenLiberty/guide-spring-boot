...
The [hotspot=installAppPackages file=0]`<installAppPackages />` tag in the [hotspot file=0]`pom.xml` 
...
== Run the repackaged Spring Boot application with Open Liberty
